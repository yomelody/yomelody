...
//  Yourcaregiver
//
//  Created by inext on 13/04/15.
//  Copyright (c) 2015 inext. All rights reserved.
    ...
    if ((self = [super initWithFrame:frame])) {
      ...
      self.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
        ...
        //self.frame=CGRectMake(0, 0, 100, 100);
          UIColor *mycolor1 = [UIColor blueColor];
        UIColor *mycolor = [UIColor clearColor];
        //          UIColor *mycolor = [UIColor pxColorWithHexValue:@"1AD"];
        
        //UIColor *viewclr = mycolor;
        SVProgressHUDBackgroundColor = mycolor;
        SVProgressHUDForegroundColor = mycolor1;
       ...
       //  SVProgressHUDErrorImage = [UIImage imageNamed:@"alert-icon.png"];
...
- (UIControl *)overlayView {
    if(!_overlayView) {
       _overlayView = [[UIControl alloc] initWithFrame:[UIScreen mainScreen].bounds];
        // _overlayView = [[UIControl alloc] initWithFrame:CGRectMake(10, 10, 50, 50)];
...
- (UIView *)hudView {
    if(!_hudView) {
      _hudView = [[UIView alloc] initWithFrame:CGRectZero];
       // _hudView = [[UIView alloc] initWithFrame:CGRectMake(50, 50, 50, 50)];
